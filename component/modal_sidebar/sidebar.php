...
?>
    ...
    { ?>
     <div id="desktop-template">
        <div class="d-flex flex-column flex-shrink-0 p-2" style="width: 200px; height: 78vh;">
            <br>
            ...
            <hr>
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle p-2"
    ...
    <div id="mobile-template">
        <div class="mobile d-flex flex-column-reverse flex-shrink-0 h-100 p-2 shadow-sm rounded" style="width: 4 rem;">
